...
function CompanySignIn() {
  ...
  try {
    ...
    sessionStorage.setItem('intended_role', 'company');
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      console.error('CompanySignIn: Google sign-in error:', authError);
    ...
    <div className="signin-page">
      <div className="signin-container">
        <div className="signin-header">
          ...
          <p>Access your emissions tracking and compliance dashboard</p>
        </div>
